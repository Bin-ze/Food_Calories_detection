...
from .single_stage1 import SingleStageDetector1


@DETECTORS.register_module()
class CenterNet(SingleStageDetector1):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(CenterNet, self).__init__(backbone, neck, bbox_head, semantic_head, train_cfg,
